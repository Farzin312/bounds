...
- [subsystem-edge-cases.md](subsystem-edge-cases.md) — the subsystem edge-case catalog: calibration scope, coverage gaps, cycles, ownership ambiguity, unsupported source, and test/documentation conventions.
